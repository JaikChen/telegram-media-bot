...
def init_db():
    ...
    # ... (保留所有原有表: seen, chats, keywords, locked, stats, rules, admins, forward_map, forward_seen, album_forwarded, footers, replacements, settings, user_whitelist) ...
    c.execute("""
